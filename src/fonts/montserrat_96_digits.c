 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/esp32-s3-amoled-175/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 96 --bpp 4 --format lvgl --lv-include lvgl.h --symbols 0123456789:-.  --no-compress -o src/fonts/montserrat_96_digits.c
 ******************************************************************************/
